...
Then open a cmd window and type “CxAPI_Store”:

C:\Users\epasanen>CxAPI_Store With no arguments, or with the -? Or /? argument, you can see all your options below:
...
```
You will want to save your credentials first. Enter: CxAPI_Store –save_credentials –user_name=”Cxuser” –password=”Cxpassword”
...
CxAPI_Store –get_token will create and store a token for CxREST services.
...
CxAPI_Store –scan_results –project_name=”CxProject” will filter for projects containing part of this name. So using “Web” will return all projects containing that substring.
